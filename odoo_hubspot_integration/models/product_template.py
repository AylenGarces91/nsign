...
class ProductTemplate_HubSpot(models.Model):
    ...
    def hubsport_to_odoo_import_product_all(self, hubspot_crm):
        ...
        try:
            ...
            while True:
                if after:
                    parameters = {"limit":"10","archived":"false","after":after,"properties":"hs_object_id,name,hs_sku,description,hs_images,hs_url,price,recurringbillingfrequency,hs_cost_of_goods_sold"}
                else:
                    parameters = {"limit":"10","archived":"false","properties":"hs_object_id,name,hs_sku,description,hs_images,hs_url,price,recurringbillingfrequency,hs_cost_of_goods_sold"}
